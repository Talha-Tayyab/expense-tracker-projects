...
export class ChartManager {
  private static pieChart: any = null;
  private static barChart: any = null;

  
  static initializeCharts(): void {
    this.createPieChart();
    this.createBarChart();
    this.updateCharts();
  }
  ...
  private static setCanvasHighDPI(canvas: HTMLCanvasElement): void {
  ...
  private static createPieChart(): void {
   ...
   */
  private static createBarChart(): void {
   ...
   */
  private static updatePieChart(expenses: Expense[], categories: { name: string; emoji: string }[]): void {
   ...
   */
  private static updateBarChart(expenses: Expense[]): void {
   ...
   */
  private static formatMonthLabel(monthString: string): string {
