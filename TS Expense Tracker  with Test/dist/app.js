...
const saveMonthlyBudgetBtn = document.getElementById("saveMonthlyBudget");
const categorySelect = document.getElementById("budgetCategorySelect");
const categoryBudgetInput = document.getElementById("categoryBudgetLimit");
const saveCategoryBudgetBtn = document.getElementById("saveCategoryBudget");
// Utility Functions
...
function renderExpenses() {
    ...
    const filtered = expenses.filter(exp => {
        ...
        const inDate = (!dateFrom || exp.date >= dateFrom) &&
